...
= 2.0.0.8 - 2019-04-16 =
* Enhancement - IF your theme or another plugin is causing a problem with the Pricing Deals screens, 
        	...
        	and click on 'Save Changes. Test in a fresh browser session.
        	('Remove Extra JS from Rule Page' is automatically set to 'Yes' for the Avada theme)
